...
7. **Vista isolada / explodida** (botão no topo, aparece com um elemento selecionado): mostra só aquele elemento numa explosão vertical — embaixo a fôrma de madeira "abre" (os taipais se separam do volume), no meio fica a montagem da armadura flutuando, e em cima o concreto "sobe" — cada camada com um rótulo flutuante com os números daquela camada (área, volume, sacos de cimento, peso das barras). A câmera se ajusta sozinha (não precisa procurar o elemento no meio da obra inteira). Bom pra conferir de perto qualquer peça antes/depois de executar.
